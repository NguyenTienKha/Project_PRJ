...
CREATE TABLE [dbo].[Product](
	...
	[Category] [char](10) NOT NULL REFERENCES [Category](Id),
...
VALUES
(1,'admin@gmail.com','Admin','6B86B273FF34FCE19D6B804EFF5A3F5747ADA4EAA22F1D49C01E52DDB7875B4B',1),
(2,'user1@gmail.com','John','D4735E3A265E16EEE03F59718B9B5D03019C07D8B6C51F90DA3A666EEC13AB35',2),
(3,'user2@gmail.com','Beck','4E07408562BEDB8B60CE05C1DECFE3AD16B72230967DE01F640B7E4729B49FCE',2)
...
INSERT INTO [Customer] ([Id],[Money],[AccountId])
VALUES
(2,10000,2),
(3,20000,3)
...
INSERT INTO [Product]([Id],[Name],[Gender],[Price],[Discount],[Category])
VALUES
